...
module MovieNightAPI 
{
	...
	{
		export function get(url: string, res: Resolver < any >, process: ProcessNode): Promise < string > 
		{
			return request({ 'method': 'GET', 'url': url }, res, process)
		}
		export function headOnly(url: string, res: Resolver < any >, process: ProcessNode): Promise < string > 
		{
			return request({ 'method': 'HEAD', 'url': url }, res, process)
		}
		export function request(options: any, res: Resolver< any >, process: ProcessNode): Promise<string> 
		{
